...
public class TestMatcherInserts extends AbstractTestMatcher {
	...
	public void insertPrivateFieldAndPublicMethodTest() throws Exception {
		Matcher matcher = new Matcher(buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndMethodInsertInstance", CONFIG_FILE_NAME));

		String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndMethodInsertInstance", BASE_BRANCH_NAME, "Square.java");
		String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndMethodInsertInstance", BRANCH_1_NAME, "Square.java");
		String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndMethodInsertInstance", BRANCH_2_NAME, "Square.java");
	...
	public void insertPrivateFieldAndPublicMethodNoMatchTest() throws Exception {
		Matcher matcher = new Matcher(buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndConstructorInsertInstance", CONFIG_FILE_NAME));

		String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndConstructorInsertInstance", BASE_BRANCH_NAME, "Square.java");
		String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndConstructorInsertInstance", BRANCH_1_NAME, "Square.java");
		String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndConstructorInsertInstance", BRANCH_2_NAME, "Square.java");
	...
	public void insertConstructorAndCompatibleMethodTest() throws Exception {
		Matcher matcher = new Matcher(buildPath(OPERATIONS_INSTANCES_DIR_PATH, "ConstructorAndCompatibleMethodInsertInstance", CONFIG_FILE_NAME));

		String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "ConstructorAndCompatibleMethodInsertInstance", BASE_BRANCH_NAME, "Square.java");
		String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "ConstructorAndCompatibleMethodInsertInstance", BRANCH_1_NAME, "Square.java");
		String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "ConstructorAndCompatibleMethodInsertInstance", BRANCH_2_NAME, "Square.java");
	...
	public void insertMethodWithInvocationTest() throws Exception {
		Matcher matcher = new Matcher(buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodWithInvocationInsertInstance", CONFIG_FILE_NAME));

		String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodWithInvocationInsertInstance", BASE_BRANCH_NAME, "Square.java");
		String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodWithInvocationInsertInstance", BRANCH_1_NAME, "Square.java");
		String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodWithInvocationInsertInstance", BRANCH_2_NAME, "Square.java");
	...
	public void insertMethodWithFieldAccessTest() throws Exception {
		Matcher matcher = new Matcher(buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodWithFieldAccessInsertInstance", CONFIG_FILE_NAME));

		String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodWithFieldAccessInsertInstance", BASE_BRANCH_NAME, "Square.java");
		String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodWithFieldAccessInsertInstance", BRANCH_1_NAME, "Square.java");
		String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodWithFieldAccessInsertInstance", BRANCH_2_NAME, "Square.java");
