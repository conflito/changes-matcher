...
public class TestFabricatedInstances extends AbstractTestMatcher {
  ...
  private static final String FABRICATED_INSTANCES_DIR_PATH = buildPath(
      RELATIVE_TEST_RESOURCES_DIR_PATH, "FabricatedInstances");

  @Test
  public void aedDependencyBasedTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "aed1617", CONFIG_FILE_NAME));

    String adlList = buildPath(RELATIVE_SRC_DIR_PATH, "datatypes", "ADLList.java");
    String cloneBuilderTest = buildPath(RELATIVE_SRC_DIR_PATH,
  ...
  public void aedSecondPhaseDependencyBasedTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "aed1617_fase2", CONFIG_FILE_NAME));
  ...
  public void ipDependencyBasedTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "ip2021", CONFIG_FILE_NAME));
  ...
  public void dcoLEIXCEL_11_12Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "leixcel1112", CONFIG_FILE_NAME));

    String leixcel = buildPath("src", "pt", "ul", "fc", "di", "dco000", "domain", "Leixcel.java");
    String catalog = buildPath("src", "pt", "ul", "fc", "di", "dco000", "domain", "formats",
        "FormatCatalog.java");
  ...
  public void cssFieldHidingTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_047", CONFIG_FILE_NAME));

    String instalacaoAssentos = buildPath(RELATIVE_SRC_DIR_PATH, "business",
        "InstalacaoAssentos.java");

    String[] baseFiles = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_047", BASE_BRANCH_NAME,
            instalacaoAssentos)
    };
    assertTrue(checkIfFilesExist(baseFiles));

    String[] variants1Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_047", BRANCH_1_NAME,
            instalacaoAssentos)
    };
    assertTrue(checkIfFilesExist(variants1Files));

    String[] variants2Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_047", BRANCH_2_NAME,
            instalacaoAssentos)
    };
    assertTrue(checkIfFilesExist(variants2Files));
  ...
  public void cssRemoveOverridingTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_047_RO", CONFIG_FILE_NAME));

    String instalacaoAssentos = buildPath(RELATIVE_SRC_DIR_PATH, "business",
        "InstalacaoAssentos.java");

    String[] baseFiles = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_047_RO", BASE_BRANCH_NAME,
            instalacaoAssentos)
    };
    assertTrue(checkIfFilesExist(baseFiles));

    String[] variants1Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_047_RO", BRANCH_1_NAME,
            instalacaoAssentos)
    };
    assertTrue(checkIfFilesExist(variants1Files));

    String[] variants2Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_047_RO", BRANCH_2_NAME,
            instalacaoAssentos)
    };
    assertTrue(checkIfFilesExist(variants2Files));
  ...
  public void cssAddOverridingTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009", CONFIG_FILE_NAME));

    String singleTicket = buildPath(RELATIVE_SRC_DIR_PATH, "business", "ticket",
        "SingleTicket.java");

    String[] baseFiles = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009", BASE_BRANCH_NAME,
            singleTicket)
    };
    assertTrue(checkIfFilesExist(baseFiles));

    String[] variants1Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009", BRANCH_1_NAME,
            singleTicket)
    };
    assertTrue(checkIfFilesExist(variants1Files));

    String[] variants2Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009", BRANCH_2_NAME,
            singleTicket)
    };
    assertTrue(checkIfFilesExist(variants2Files));
  ...
  public void cssAccessChangeTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_AC", CONFIG_FILE_NAME));
    ...
    String[] baseFiles = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_AC", BASE_BRANCH_NAME,
            event),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_AC", BASE_BRANCH_NAME,
            producer)
    };
  ...
  public void cssOverloadByAdditionTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_OA", CONFIG_FILE_NAME));

    String event = buildPath(RELATIVE_SRC_DIR_PATH, "business", "event", "Event.java");
    String producer = buildPath(RELATIVE_SRC_DIR_PATH, "business", "producer", "Producer.java");

    String[] baseFiles = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_OA", BASE_BRANCH_NAME,
            event),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_OA", BASE_BRANCH_NAME,
            producer)
    };
  ...
  public void cssUnexpectedOverridingTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_UN", CONFIG_FILE_NAME));
    ...
    String[] baseFiles = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_UN", BASE_BRANCH_NAME,
            ticket),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_UN", BASE_BRANCH_NAME,
            reservation)
    };
    ...
    String[] variants1Files = {
        ...
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_UN", BRANCH_1_NAME,
            reservation)
    };
    assertTrue(checkIfFilesExist(variants1Files));
    ...
    String[] variants2Files = {
        ...
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_UN", BRANCH_2_NAME,
            reservation)
    };
    assertTrue(checkIfFilesExist(variants2Files));
  ...
  public void cssNoConflictTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_no_conflict",
            CONFIG_FILE_NAME));

    String seat = buildPath(RELATIVE_SRC_DIR_PATH, "business", "event", "Seat.java");
    String handler = buildPath(RELATIVE_SRC_DIR_PATH, "business", "handlers",
        "CreateEventHandler.java");
    String producer = buildPath(RELATIVE_SRC_DIR_PATH, "business", "producer", "Producer.java");
    String coupleTicket = buildPath(RELATIVE_SRC_DIR_PATH, "business", "ticket",
        "CouplesTicket.java");
    String familyTicket = buildPath(RELATIVE_SRC_DIR_PATH, "business", "ticket",
        "FamilyTicket.java");

    String[] baseFiles = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_no_conflict",
            BASE_BRANCH_NAME, seat),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_no_conflict",
            BASE_BRANCH_NAME, handler),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_no_conflict",
            BASE_BRANCH_NAME, producer),
        null,
        null
    };
    assertTrue(checkIfFilesExist(baseFiles));
    ...
    String[] variants1Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_no_conflict", BRANCH_1_NAME,
            seat),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_no_conflict", BRANCH_1_NAME,
            handler),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_no_conflict", BRANCH_1_NAME,
    ...
    String[] variants2Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_no_conflict", BRANCH_2_NAME,
            seat),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_no_conflict", BRANCH_2_NAME,
            handler),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css2021_projeto1_009_no_conflict", BRANCH_2_NAME,
  ...
  public void cssNoConflictTest2() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_047_no_conflict", CONFIG_FILE_NAME));
    ...
    String[] baseFiles = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_047_no_conflict", BASE_BRANCH_NAME, "BilGes",
            client),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_047_no_conflict", BASE_BRANCH_NAME, "BilGes",
            lugarDTO),
    };
    ...
    String[] variants1Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_047_no_conflict", BRANCH_1_NAME, "BilGes",
            client),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_047_no_conflict", BRANCH_1_NAME, "BilGes",
            lugarDTO),
    };
    ...
    String[] variants2Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_047_no_conflict", BRANCH_2_NAME, "BilGes",
            client),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_047_no_conflict", BRANCH_2_NAME, "BilGes",
            lugarDTO),
    };
  ...
  public void cssNoConflictTest3() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_009_no_conflict_2", CONFIG_FILE_NAME));

    String eventCatalog = buildPath(RELATIVE_SRC_DIR_PATH, "business", "catalogs",
        "EventCatalog.java");
    String ticketCatalog = buildPath(RELATIVE_SRC_DIR_PATH, "business", "catalogs",
        "TicketCatalog.java");
    ...
    String[] baseFiles = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_009_no_conflict_2", BASE_BRANCH_NAME,
            eventCatalog),
        null,
        null,
    ...
    String[] variants1Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_009_no_conflict_2", BRANCH_1_NAME,
            eventCatalog),
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_009_no_conflict_2", BRANCH_1_NAME,
            ticketCatalog),
        null,
    ...
    String[] variants2Files = {
        buildPath(FABRICATED_INSTANCES_DIR_PATH, "css_009_no_conflict_2", BRANCH_2_NAME,
            eventCatalog),
        null,
