...
public class TestMatcherDeletes extends AbstractTestMatcher {
  ...
  public void deletePrivateFieldAndPublicMethodTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndMethodDeleteInstance", CONFIG_FILE_NAME));

    String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndMethodDeleteInstance",
        BASE_BRANCH_NAME, "Square.java");
    String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndMethodDeleteInstance",
        BRANCH_1_NAME, "Square.java");
    String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndMethodDeleteInstance",
  ...
  public void deletePrivateFieldAndPublicConstructorTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndConstructorDeleteInstance",
            CONFIG_FILE_NAME));

    String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndConstructorDeleteInstance",
        BASE_BRANCH_NAME, "Square.java");
    String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "FieldAndConstructorDeleteInstance", BRANCH_1_NAME, "Square.java");
    String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "FieldAndConstructorDeleteInstance", BRANCH_2_NAME, "Square.java");
  ...
  public void deleteFieldAndCompatibleMethodTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAndCompatibleMethodDeleteInstance",
            CONFIG_FILE_NAME));

    String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "FieldAndCompatibleMethodDeleteInstance", BASE_BRANCH_NAME, "Square.java");
    String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "FieldAndCompatibleMethodDeleteInstance", BRANCH_1_NAME, "Square.java");
    String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "FieldAndCompatibleMethodDeleteInstance", BRANCH_2_NAME, "Square.java");
  ...
  public void deleteFieldAndMethodInvocationTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodInvocationAndFieldDeleteInstance",
            CONFIG_FILE_NAME));

    String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "MethodInvocationAndFieldDeleteInstance", BASE_BRANCH_NAME, "Shape.java");
    String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "MethodInvocationAndFieldDeleteInstance", BRANCH_1_NAME, "Shape.java");
    String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "MethodInvocationAndFieldDeleteInstance", BRANCH_2_NAME, "Shape.java");
  ...
  public void deleteFieldAccessAndMethodTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAccessAndMethodDeleteInstance",
            CONFIG_FILE_NAME));

    String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH, "FieldAccessAndMethodDeleteInstance",
        BASE_BRANCH_NAME, "Square.java");
    String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "FieldAccessAndMethodDeleteInstance", BRANCH_1_NAME, "Square.java");
    String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "FieldAccessAndMethodDeleteInstance", BRANCH_2_NAME, "Square.java");
