...
public class TestMatcherUpdates extends AbstractTestMatcher {
  ...
  public void methodUpdateWithInsertOperationTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodUpdateWithInsertOperationInstance",
            CONFIG_FILE_NAME));

    String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "MethodUpdateWithInsertOperationInstance", BASE_BRANCH_NAME, "Square.java");
    String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "MethodUpdateWithInsertOperationInstance", BRANCH_1_NAME, "Square.java");
    String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "MethodUpdateWithInsertOperationInstance", BRANCH_2_NAME, "Square.java");
  ...
  public void methodUpdateWithDeleteOperationTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(OPERATIONS_INSTANCES_DIR_PATH, "MethodUpdateWithDeleteOperationInstance",
            CONFIG_FILE_NAME));

    String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "MethodUpdateWithDeleteOperationInstance", BASE_BRANCH_NAME, "Shape.java");
    String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "MethodUpdateWithDeleteOperationInstance", BRANCH_1_NAME, "Shape.java");
    String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "MethodUpdateWithDeleteOperationInstance", BRANCH_2_NAME, "Shape.java");
  ...
  public void constructorUpdateWithInsertOperationTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(OPERATIONS_INSTANCES_DIR_PATH, "ConstructorUpdateWithInsertOperationInstance",
            CONFIG_FILE_NAME));

    String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "ConstructorUpdateWithInsertOperationInstance", BASE_BRANCH_NAME, "Square.java");
    String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "ConstructorUpdateWithInsertOperationInstance", BRANCH_1_NAME, "Square.java");
    String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "ConstructorUpdateWithInsertOperationInstance", BRANCH_2_NAME, "Square.java");
  ...
  public void constructorUpdateWithDeleteOperationTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(OPERATIONS_INSTANCES_DIR_PATH, "ConstructorUpdateWithDeleteOperationInstance",
            CONFIG_FILE_NAME));

    String basePath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "ConstructorUpdateWithDeleteOperationInstance", BASE_BRANCH_NAME, "Square.java");
    String firstVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "ConstructorUpdateWithDeleteOperationInstance", BRANCH_1_NAME, "Square.java");
    String secondVarPath = buildPath(OPERATIONS_INSTANCES_DIR_PATH,
        "ConstructorUpdateWithDeleteOperationInstance", BRANCH_2_NAME, "Square.java");
