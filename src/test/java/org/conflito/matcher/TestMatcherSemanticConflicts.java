...
public class TestMatcherSemanticConflicts extends AbstractTestMatcher {
  ...
  private static final String SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH = buildPath(
      RELATIVE_TEST_RESOURCES_DIR_PATH, "SemanticConflictsInstances");
  ...
  public void overloadByAdditionNewMethodTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "AddOverloadingMByAdditionAddCall2M",
            CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByAdditionAddCall2M", BASE_BRANCH_NAME, "A.java");
    String firstVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByAdditionAddCall2M", BRANCH_1_NAME, "A.java");
    String secondVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByAdditionAddCall2M", BRANCH_2_NAME, "A.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "OverloadByAdditionNewMethod.co");
  ...
  public void overloadByAdditionNewClassTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "AddOverloadingMByAdditionAddCall2M_01",
            CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByAdditionAddCall2M_01", BASE_BRANCH_NAME, "A.java");
    String firstVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByAdditionAddCall2M_01", BRANCH_1_NAME, "A.java");
    String secondVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByAdditionAddCall2M_01", BRANCH_2_NAME, "B.java");
  ...
  public void overloadByAdditionNewCallTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "AddOverloadingMByAdditionAddCall2M_02",
            CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByAdditionAddCall2M_02", BASE_BRANCH_NAME, "A.java");
    String firstVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByAdditionAddCall2M_02", BRANCH_1_NAME, "A.java");
    String secondVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByAdditionAddCall2M_02", BRANCH_2_NAME, "A.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "OverloadByAdditionNewDependency.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void addFieldHidingTest() throws Exception {
    Matcher matcher = new Matcher(buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddFieldHidingAddMethodThatUseDefFinChild", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddFieldHidingAddMethodThatUseDefFinChild", BASE_BRANCH_NAME, "B.java");
    String firstVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddFieldHidingAddMethodThatUseDefFinChild", BRANCH_1_NAME, "B.java");
    String secondVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddFieldHidingAddMethodThatUseDefFinChild", BRANCH_2_NAME, "B.java");
  ...
  public void overloadingAccessChangeNewMethodTest() throws Exception {
    Matcher matcher = new Matcher(buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M", CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M", BASE_BRANCH_NAME, "A.java");
    String base2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M", BASE_BRANCH_NAME, "B.java");
    String firstVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M", BRANCH_1_NAME, "A.java");
    String secondVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M", BRANCH_2_NAME, "B.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "OverloadByAccessChangeNewMethod.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void overloadingAccessChangeNewCallTest() throws Exception {
    Matcher matcher = new Matcher(buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M_02", CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M_02", BASE_BRANCH_NAME, "A.java");
    String base2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M_02", BASE_BRANCH_NAME, "B.java");
    String firstVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M_02", BRANCH_1_NAME, "A.java");
    String secondVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M_02", BRANCH_2_NAME, "B.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "OverloadByAccessChangeNewDependency.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void overloadingAccessChangeNewClassTest() throws Exception {
    Matcher matcher = new Matcher(buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M_01", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M_01", BASE_BRANCH_NAME, "A.java");
    String firstVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M_01", BRANCH_1_NAME, "A.java");
    String secondVarPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility1AddCall2M_01", BRANCH_2_NAME, "B.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "OverloadByAccessChangeNewClass.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void overloadingAccessChange2NewMethodTest() throws Exception {
    Matcher matcher = new Matcher(buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M", CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M", BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M", BRANCH_1_NAME, "A.java");
    String base2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M", BASE_BRANCH_NAME, "B.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M", BRANCH_2_NAME, "B.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "OverloadByAccessChange2NewMethod.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void overloadingAccessChange2NewCallTest() throws Exception {
    Matcher matcher = new Matcher(buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M_02", CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M_02", BASE_BRANCH_NAME, "A.java");
    String base2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M_02", BASE_BRANCH_NAME, "B.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M_02", BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M_02", BRANCH_2_NAME, "B.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "OverloadByAccessChange2NewDependency.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void overloadingAccessChange2NewClassTest() throws Exception {
    Matcher matcher = new Matcher(buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M_01", CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M_01", BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M_01", BRANCH_1_NAME, "A.java");
    String newClassPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverloadingMByChangeAccessibility2AddCall2M_01", BRANCH_2_NAME, "B.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "OverloadByAccessChange2NewClass.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void addMethodOverridingNewMethodTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "AddOverridingMAddCall2MinChild",
            CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverridingMAddCall2MinChild", BASE_BRANCH_NAME, "B.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverridingMAddCall2MinChild", BRANCH_1_NAME, "B.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverridingMAddCall2MinChild", BRANCH_2_NAME, "B.java");
  ...
  public void addMethodOverridingNewClassTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "AddOverridingMAddCall2MinChild_01",
            CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverridingMAddCall2MinChild_01", BASE_BRANCH_NAME, "B.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverridingMAddCall2MinChild_01", BRANCH_1_NAME, "B.java");
    String newClassPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverridingMAddCall2MinChild_01", BRANCH_2_NAME, "C.java");
  ...
  public void addMethodOverridingNewCallTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "AddOverridingMAddCall2MinChild_02",
            CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverridingMAddCall2MinChild_02", BASE_BRANCH_NAME, "B.java");
    String basePath2 = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverridingMAddCall2MinChild_02", BASE_BRANCH_NAME, "C.java");

    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverridingMAddCall2MinChild_02", BRANCH_1_NAME, "B.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "AddOverridingMAddCall2MinChild_02", BRANCH_2_NAME, "C.java");
  ...
  public void removeOverridingTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "RemoveOverridingMAddCall2M",
            CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "RemoveOverridingMAddCall2M",
        BASE_BRANCH_NAME, "B.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "RemoveOverridingMAddCall2M",
        BRANCH_1_NAME, "B.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "RemoveOverridingMAddCall2M",
        BRANCH_2_NAME, "B.java");
  ...
  public void changeMethod1Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod01", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod01",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod01",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod01",
        BRANCH_2_NAME, "A.java");
  ...
  public void changeMethod1_1Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod01_01", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod01_01",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod01_01",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod01_01",
        BRANCH_2_NAME, "A.java");
  ...
  public void changeMethod2Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod02", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod02",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod02",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod02",
        BRANCH_2_NAME, "A.java");
  ...
  public void changeMethod3Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod03", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod03",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod03",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ChangeMethod03",
        BRANCH_2_NAME, "A.java");
  ...
  public void dependencyBased1Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased01", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased01",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased01",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased01",
        BRANCH_2_NAME, "A.java");
  ...
  public void dependencyBased1_01Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased01_01", CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased01_01",
        BASE_BRANCH_NAME, "A.java");
    String base2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased01_01",
        BASE_BRANCH_NAME, "B.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased01_01",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased01_01",
        BRANCH_2_NAME, "B.java");
  ...
  public void dependencyBased2Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased02", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased02",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased02",
        BRANCH_1_NAME, "A.java");
    String newClassPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased02",
        BRANCH_2_NAME, "B.java");
  ...
  public void dependencyBased2_01Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased02_01", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased02_01",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased02_01",
        BRANCH_1_NAME, "A.java");
    String newClassPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased02_01",
        BRANCH_2_NAME, "B.java");
    String newClass2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased02_01",
        BRANCH_2_NAME, "C.java");
  ...
  public void dependencyBased3Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased03", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased03",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased03",
        BRANCH_1_NAME, "A.java");
    String newClassPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased03",
        BRANCH_2_NAME, "B.java");
  ...
  public void dependencyBased4Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased04", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased04",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased04",
        BRANCH_1_NAME, "A.java");
    String newClassPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased04",
        BRANCH_2_NAME, "B.java");
  ...
  public void dependencyBased7Test() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased07", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased07",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased07",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "DependencyBased07",
        BRANCH_2_NAME, "A.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "DependencyBasedNewDependency.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void unexpectedOverridingNewMethodTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01",
            CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01",
        BASE_BRANCH_NAME, "A.java");
    String base2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01",
        BASE_BRANCH_NAME, "B0.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01",
        BRANCH_2_NAME, "B0.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "UnexpectedOverridingNewMethod.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void unexpectedOverridingNewClassTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01_01",
            CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01_01",
        BASE_BRANCH_NAME, "B0.java");
    String newClassPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "UnexpectedOverriding01_01", BRANCH_1_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01_01",
        BRANCH_2_NAME, "B0.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "UnexpectedOverridingNewClass.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void unexpectedOverridingNewCallTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01_02",
            CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01_02",
        BASE_BRANCH_NAME, "A.java");
    String base2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01_02",
        BASE_BRANCH_NAME, "B0.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01_02",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding01_02",
        BRANCH_2_NAME, "B0.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "UnexpectedOverridingNewDependency.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void unexpectedOverriding3NewMethodTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03",
            CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03",
        BASE_BRANCH_NAME, "B.java");
    String base2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03",
        BASE_BRANCH_NAME, "C.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03",
        BRANCH_1_NAME, "B.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03",
        BRANCH_2_NAME, "C.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "UnexpectedOverriding3NewMethod.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void unexpectedOverriding3NewClassTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03_02",
            CONFIG_FILE_NAME));

    String base1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03_02",
        BASE_BRANCH_NAME, "B.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03_02",
        BRANCH_1_NAME, "B.java");
    String newClassPath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH,
        "UnexpectedOverriding03_02", BRANCH_2_NAME, "C.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "UnexpectedOverriding3NewClass.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void unexpectedOverriding3NewCallTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03_01",
            CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03_01",
        BASE_BRANCH_NAME, "B.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03_01",
        BRANCH_1_NAME, "B.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "UnexpectedOverriding03_01",
        BRANCH_2_NAME, "B.java");
    ...
    String conflictPath = buildPath(RELATIVE_SRC_RESOURCES_DIR_PATH, CONFLICT_PATTERNS_DIR_NAME,
        "UnexpectedOverriding3NewDependency.co");
    assertTrue(checkIfFilesExist(new String[]{conflictPath}));
  ...
  public void parallelChangesTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ParallelChanges", CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ParallelChanges",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ParallelChanges",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ParallelChanges",
        BRANCH_2_NAME, "A.java");
  ...
  public void parallelChangesConstructorTest() throws Exception {
    Matcher matcher = new Matcher(
        buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ParallelChangesConstructor",
            CONFIG_FILE_NAME));

    String basePath = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ParallelChangesConstructor",
        BASE_BRANCH_NAME, "A.java");
    String var1Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ParallelChangesConstructor",
        BRANCH_1_NAME, "A.java");
    String var2Path = buildPath(SEMANTIC_CONFLICTS_INSTANCES_DIR_PATH, "ParallelChangesConstructor",
        BRANCH_2_NAME, "A.java");
