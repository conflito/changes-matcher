...
public class SpoonHandler {
  ...
  private final Launcher baseLauncher;
  private final Launcher variantLauncher1;
  private final Launcher variantLauncher2;

  private Set<CtType<?>> baseTypes;
  private Set<CtType<?>> variant1Types;
  private Set<CtType<?>> variant2Types;

  private final Map<String, CtType<?>> baseMap;
  private final Map<String, CtType<?>> variant1Map;
  private final Map<String, CtType<?>> variant2Map;
  ...
  private void calculateDependantsAndDependencies(
      Map<CtMethod<?>, Set<CtMethod<?>>> directDependents,
