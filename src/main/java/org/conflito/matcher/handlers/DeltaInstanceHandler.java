...
import org.conflito.matcher.processors.DeleteActionsProcessor;
import org.conflito.matcher.processors.InsertActionsProcessor;
import org.conflito.matcher.processors.MoveActionsProcessor;
import org.conflito.matcher.processors.UpdateActionsProcessor;
import org.conflito.matcher.processors.VisibilityDeleteActionsProcessor;
import org.conflito.matcher.processors.VisibilityInsertActionsProcessor;
import org.conflito.matcher.processors.VisibilityUpdateActionsProcessor;
...
public class DeltaInstanceHandler {
  ...
  private void processMoveOperation(Operation<?> o, DeltaInstance deltaInstance,
      ConflictPattern cp) {
  ...
  private void processUpdateAction(Operation<?> o, DeltaInstance deltaInstance,
      ConflictPattern cp) {
  ...
  private void processDeleteAction(Operation<?> o, DeltaInstance deltaInstance,
      ConflictPattern cp) {
  ...
  private void processInsertAction(Operation<?> o, DeltaInstance deltaInstance,
      ConflictPattern cp) {
