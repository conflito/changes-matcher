package org.conflito.matcher.patterns.goals;
...
public class TestingGoal {
  ...
  private final ClassPattern targetClass;

  private final List<Pair<ClassPattern, MethodPattern>> methodsToCall;

  private final List<Pair<ClassPattern, ConstructorPattern>> constructorsToCall;
