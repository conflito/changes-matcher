...
public class InsertConstructorPatternAction extends InsertPatternAction {
  ...
  private final ConstructorPattern insertedConstructorPattern;
  ...
  public String toString() {
    String result = "Insert constructor $" + insertedConstructorPattern.getVariableId()
        + " in class $" + holderClassPattern.getVariableId() + "\n"
        + insertedConstructorPattern.toString();
    return result;
  }
