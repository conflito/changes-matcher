...
import org.conflito.matcher.entities.deltas.InsertMethodAction;
...
public class InsertMethodPatternAction extends InsertPatternAction {
  ...
  private final MethodPattern insertedMethodPattern;

  private final ClassPattern holderClassPattern;

  private final List<MethodPattern> compatibles;

  public InsertMethodPatternAction(MethodPattern insertedMethodPattern,
