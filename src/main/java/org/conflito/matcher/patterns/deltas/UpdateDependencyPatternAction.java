...
public class UpdateDependencyPatternAction extends UpdatePatternAction {
  ...
  private final FreeVariable oldDependency;

  private final FreeVariable newDependency;

  public UpdateDependencyPatternAction(MethodPattern holderMethodPattern,
      FreeVariable oldDependency,
  ...
  public UpdateDependencyPatternAction(ConstructorPattern holderConstructorPattern,
      FreeVariable oldDependency,
      FreeVariable newDependency) {
    super();
