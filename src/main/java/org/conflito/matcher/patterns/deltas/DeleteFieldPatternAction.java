...
public class DeleteFieldPatternAction extends DeletePatternAction {
  ...
  private final FieldPattern deletedFieldPattern;

  private final ClassPattern holderClassPattern;

  public DeleteFieldPatternAction(FieldPattern deletedFieldPattern,
  ...
  public String toString() {
    String result = "Delete field $" + deletedFieldPattern.getVariableId()
