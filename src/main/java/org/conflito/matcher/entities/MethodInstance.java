...
public class MethodInstance implements Visible {
  ...
  private final List<FieldAccessInstance> fieldAccesses;
   ...
   * @param visibility the method's visibility
   * @param returnType the method's return type
   * @param parameters the method's parameters' types
   */
  public MethodInstance(String name, Visibility visibility, Type returnType,
   ...
   *
   * @param m the new method dependency
   */
   ...
   * @return true if this method depends (directly or not) to a method with the name methodName;
   * false otherwise
   */
   ...
   *
   * @param methodName the name of the method to test dependency
   * @param visited    names of the methods already visited to avoid loops
   * @return true if this method depends (directly or not) to a method with the name methodName;
   * false otherwise
   */
   ...
   * <br><br>
   * A method M is compatible with a methond N if:<br> - M and N have the same name <b>and</b><br> -
   * M and N have the same number of parameters <b>and</b><br> - For 0<=i<=X, where X is the number
   * of parameters, the i-th parameter of M is sub-type of the i-th parameter of N
   *
