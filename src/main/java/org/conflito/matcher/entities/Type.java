...
public class Type {
  ...
  private final CtTypeReference<?> typeRef;

  /**
   * Creates an instance of Type
   *
   * @param type the Spoon CtTypeReference
   */
   ...
   *
   * @return the component type of this array type; null if this type is not an array type
   */
   ...
   *
   * @param type the type to obtain the wrapper type
