...
public class InsertMethodAction extends InsertAction {
  ...
  private final MethodInstance insertedMethod;

  private final ClassInstance holderClass;

  private final List<MethodInstance> compatibles;
  ...
  public boolean equals(Object obj) {
    ...
    if (insertedMethod == null) {
      return other.insertedMethod == null;
    } else
      return insertedMethod.equals(other.insertedMethod);
  }
