...
public class UpdateConstructorAction extends UpdateAction {
  ...
  private final ConstructorInstance updatedConstructorInstance;
  ...
  public int hashCode() {
    final int prime = 31;
    int result = 1;
    result = prime * result + ((updatedConstructorInstance == null) ? 0
        : updatedConstructorInstance.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (updatedConstructorInstance == null) {
      return other.updatedConstructorInstance == null;
    } else
      return updatedConstructorInstance.equals(other.updatedConstructorInstance);
  }
