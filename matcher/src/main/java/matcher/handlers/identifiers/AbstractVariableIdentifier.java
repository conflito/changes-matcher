...
public abstract class AbstractVariableIdentifier {

	protected void mergeMaps(Map<Integer, List<String>> first, 
	...
	protected Map<Integer,List<String>> combine(List<Integer> vars, List<String> names){
	...
	public abstract Map<Integer, List<String>> identify(ChangeInstance changeInstance
