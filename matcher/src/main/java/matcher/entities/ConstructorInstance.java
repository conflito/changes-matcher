...
public class ConstructorInstance implements Visible {
	 ...
	 * @return true if this constructor depends on a method with a name of methodName; 
	 * 		false otherwise
	 */
	...
	/**
	 * Get this constructor's qualified name<br>
	 * A constructor's qualified name is made up of it's class' name, its name 
	 * 		and its parameters
	...
	/**
	 * Get this constructor's simple name<br>
	 * A constructor's simple name is its class name and its parameters
	 * @return
	 */
